...
from utils.file_io import _session_id as generate_session_id, save_uploaded_files
from utils.document_ops import (
    load_documents,
    concat_for_analysis,
...
# ============================================================
# DocumentComparator (file-based)
# ============================================================
class DocumentComparator:
    """
    Save, read & combine PDFs for comparison (non-LLM).
    """
    ...
    def __init__(
        ...
        log.info(
            "DocumentComparator initialized",
